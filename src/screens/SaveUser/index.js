...
export default function SaveUser({ navigation, route }) {
    ...
    const chartData = {
        ...
        datasets: [
            {
                data: [0, 7, 0, 0, 0],
                color: (opacity = 1) => colors.blue, // red color
                strokeWidth: 1,
            },
            {
                data: [0, 9, 0, 0, 0],
                color: (opacity = 1) => colors.blue, // blue color
                strokeWidth: 1,
            }
        ],
    };
    ...
    return (
        <View style={styles.container}>
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: 'center' }}>
                <HeaderItem text={userRecord.name} showSearch={true} image={<Text style={{ color: colors.white, fontSize: 12, fontFamily: 'Gilroy-SemiBold' }}>Age,49 years</Text>} onBack={() => navigation.goBack()} />
                <View style={{ marginLeft: wp(5), marginTop: hp(5), alignItems: 'center' }}>
                    <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>BODY MASS INDEX</Text>
                ...
                <View style={{ width: '100%', alignItems: 'center', flexDirection: 'row', justifyContent: 'center' }}>
                    <View>
                        <View style={{ marginLeft: wp(10), alignItems: 'center' }}>
                            <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>HEIGHT</Text>
                        ...
                        <View style={{ marginRight: wp(5), marginTop: hp(2), alignItems: 'center' }}>
                            <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>TEMPERATURE</Text>
                    ...
                    <View>
                        <View style={{ marginRight: wp(10), alignItems: 'center' }}>
                            <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>WEIGHT</Text>
                        ...
                        <View style={{ marginLeft: wp(5), marginTop: hp(2), alignItems: 'center' }}>
                            <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>PULSE RATE</Text>
                ...
                <View style={{ marginLeft: wp(5), marginTop: hp(1), alignItems: 'center' }}>
                    <Text style={{ fontSize: 9, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}>BODY PRESSURE</Text>
                ...
                <View style={{ width: '90%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <Text style={{ fontSize: 8, fontFamily: 'Gilroy-SemiBold', color: colors.blue }}> update vital</Text>
                </View>
                <View style={{ width: '90%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: '10%' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 12, fontFamily: 'Gilroy-SemiBold', color: colors.blue, paddingLeft: '2%' }}>HEIGHT</Text>
                    </View>
                ...
                <View style={{ width: '90%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: '2%' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 12, fontFamily: 'Gilroy-SemiBold', color: colors.blue, paddingLeft: '2%' }}>PULSE RATE</Text>
                    </View>
                ...
                <View style={{ width: '90%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginTop: '2%' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 12, fontFamily: 'Gilroy-SemiBold', color: colors.blue, paddingLeft: '2%' }}>WEIGHT</Text>
                    </View>
                ...
                <TouchableOpacity style={{ backgroundColor: colors.blue, height: hp(5), width: wp(25), alignItems: 'center', justifyContent: 'center', borderRadius: 5, alignSelf: 'flex-start', marginLeft: '5%', marginTop: '5%' }}>
                ...
                <Text style={{ fontSize: 10, fontFamily: 'Gilroy-Medium', color: colors.blue, width: '77%', marginTop: '2%' }}>Order date: <Text style={{ color: colors.black }}>14 JUN 2024</Text></Text>
                <Text style={{ fontSize: 10, fontFamily: 'Gilroy-Medium', color: colors.blue, width: '77%', marginTop: '2%' }}>COMPLETED</Text>
                <View style={{ width: '100%', alignItems: 'center', marginTop: '10%', marginBottom: '5%' }}>
                    <Button2 Text="Save Users" backgroundColor={colors.blue} onPress={() => navigation.navigate('UploadDoc')} />
                </View>
            </ScrollView>
        </View>
    );
