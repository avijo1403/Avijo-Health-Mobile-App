...
const Chat = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.Container}>
            <HeaderItem2 center={true} name={name} profileImage={name === "Dr. Jii (Ai health assistance)" ? require('../../assets/images/dr-ji.png') : require('../../assets/images/healthrecord.png')} backgroundColor={colors.blue} onPress={() => navigation.goBack()} right={<Image source={require('../../assets/images/whiteDot.png')} style={{ height: 24, width: 24 }} />} />
            <ScrollView
