        ...
        <View style={styles.container}>
            ...
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: 'center', paddingBottom: "5%" }}>
                ...
                <View style={{ width: "90%", alignItems: 'center', flexDirection: 'row', marginTop: "3%" }}>
                    ...
                    <Text style={{ fontSize: 16, fontFamily: 'Gilroy-SemiBold', color: colors.green, paddingLeft: '3%' }}><Text style={{ fontSize: 14, color: colors.black }}>Ac60</Text> Your save 70% </Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '90%', marginTop: "5%" }}>
                    ...
                    <Text style={{ fontSize: 12, fontFamily: 'Gilroy-Bold', color: colors.green }}>SELECT ADDRESS</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '90%', marginTop: "5%" }}>
                    ...
                    <Text style={{ fontSize: 14, fontFamily: 'Gilroy-Bold', color: colors.green }}>To be decided</Text>
                </View>
                ...
                <TouchableOpacity style={[styles.buttonSubContainer, { backgroundColor: colors.green }]}>
                ...
                <TouchableOpacity style={{ width: "90%" }}>
                    <Text style={{ fontSize: 14, fontFamily: 'Gilroy-Regular', color: colors.green }}>TERM &  CONDITIONS.</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    )
