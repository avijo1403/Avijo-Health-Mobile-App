            ...
            <View style={styles.container}>
                <View style={{ width: '100%', alignItems: 'center' }}>
                    <FlatList
                        ...
                        data={profileOption}
                        renderItem={({ item }) => (
                            <View style={{ flexDirection: 'column', width: '100%', marginBottom: '5%', marginTop: '5%', borderWidth: 1, padding: 10, borderColor: colors.grey, borderRadius: 4, backgroundColor: colors.white }}>
                                <TouchableOpacity style={{ alignSelf: "flex-end" }}>
                                    <Image source={require('../../assets/images/dot3.png')} style={{ height: 20, width: 20 }} />
                                </TouchableOpacity>
                                <Image source={require('../../assets/images/post1.png')} style={{ height: 200, width: '100%', borderRadius: 24, marginTop: '5%' }} />
