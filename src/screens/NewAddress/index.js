        ...
        <View style={styles.container}>
            ...
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: "center" }}>
                ...
                <View style={{ flexDirection: 'row', width: '90%', alignItems: 'center' }}>
                    ...
                    <View style={{ width: '72%' }}>
                        <Text style={{ fontSize: 18, fontFamily: 'Gilroy-Medium', color: colors.black, width: '90%', marginTop: '5%' }}>City/State</Text>
                        <TextInput
                            style={styles.input}
                            placeholder="Dhar, Madhya Pradesh"
                            placeholderTextColor={colors.darkGrey}
                            value={city}
                ...
                />
                <Text style={{ fontSize: 18, fontFamily: 'Gilroy-Medium', color: colors.black, width: '90%', marginTop: '5%' }}>Address</Text>
                <TextInput
                    style={styles.input}
                    placeholder="CD Bshxh"
                    placeholderTextColor={colors.darkGrey}
                    value={address}
                    onChangeText={setAddress}
                />
                <Text style={{ fontSize: 18, fontFamily: 'Gilroy-Medium', color: colors.black, width: '90%', marginTop: '5%' }}>Landmark</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Xhesh"
                    placeholderTextColor={colors.darkGrey}
