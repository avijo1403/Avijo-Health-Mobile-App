    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: "center" }}>
                <Text style={{ fontSize: 24, fontFamily: 'Gilroy-Bold', color: colors.green, width: '90%', marginTop: '8%', lineHeight: 30 }}>Pysical examinations and vaccinations</Text>
                ...
                <Text style={{ fontSize: 18, fontFamily: 'Gilroy-SemiBold', color: colors.green, width: '90%', marginTop: '3%' }}>Get Directions</Text>
