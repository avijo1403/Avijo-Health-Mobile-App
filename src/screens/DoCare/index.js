        ...
        <View style={styles.container}>
            ...
            <ScrollView style={{ width: '100%' }} contentContainerStyle={{ alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', alignItems: 'start', backgroundColor:colors.white, width:'100%', padding:'5%' }}>
                    ...
                    <View style={{ width: '80%' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', width: '90%', justifyContent: 'flex-start', marginLeft: '5%', marginTop: '2%' }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginTop: '5%', width: '30%', backgroundColor: colors.lightgrey, padding: '2%', marginLeft: '5%' }}>
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ width: '90%', alignItems: 'center', borderWidth: 1, borderColor: colors.lightgrey, borderRadius: 5, marginTop: '3%', padding: '3%', }}>
